...
import emailTemplatePasswordResetSuccess from '~/modules/nuxt-mailer/runtime/emailTemplates/password-reset-success'
...
export default defineEventHandler(async (event) => {
  try {
    ...
    const emailBody = emailTemplatePasswordResetSuccess(user.name)
